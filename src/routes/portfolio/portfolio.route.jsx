    ...
    <div className={styleProjectsContainer}>
      <div className='collapse collapse-arrow bg-base-100 mb-4 rounded-lg'>
        ...
        <div className='collapse-title text-xl font-medium flex flex-row justify-start'>
          <img className='w-48 h-32 rounded-md m-4' src='/quiz.jpg' />
          <div className='h-full p-2 self-center flex flex-col'>
            <h3 className='pl-5 pb-2 text-2xl text-secondary font-bold'>
              Frontend Quiz App
            </h3>
            <ul className='pl-5 list-disc text-base'>
              <li>Mobile-ready design</li>
              <li>Answer options shuffling</li>
              <li>Answers' highlighting</li>
              <li>Funny debrief</li>
            </ul>
          </div>
        </div>
        <div className='collapse-content prose m-auto'>
          <p className='ml-4'>
            In this project, I participated not only as a developer but also as
            a team lead. I designed the project structure, the application
            logic, and selected the tools we used. Every day, I assigned tasks
            to other team members, monitored the progress, and assisted
            colleagues when necessary. Еhe idea of using funny GIFs and their
            creation was also my responsibility.
          </p>
